...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FftwLearning Demo Installer\n"
      else:
        line="OutputBaseFilename=FftwLearning Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FftwLearning Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FftwLearning installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FftwLearning Demo installer\n"
     else:
       line="SetupWindowTitle=FftwLearning installer\n"
